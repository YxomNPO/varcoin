...
public:
  ...
  virtual void getNewBlocks(std::vector<Crypto::Hash>&& knownBlockIds, std::vector<VarNote::block_complete_entry>& newBlocks, uint32_t& startHeight, const Callback& callback) = 0;
