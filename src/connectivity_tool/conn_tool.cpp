...
typedef COMMAND_REQUEST_STAT_INFO_T<t_VarNote_protocol_handler<core>::stat_info> COMMAND_REQUEST_STAT_INFO;
...
bool handle_get_daemon_info(po::variables_map& vm)
{
  ...
  VarNote::COMMAND_RPC_GET_INFO::response res = AUTO_VAL_INIT(res);
