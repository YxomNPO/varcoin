...
namespace nodetool
{
  ...
  {
    if (!testnet) {
      ADD_HARDCODED_SEED_NODE("seed.varcoin.info:19898");
	  ADD_HARDCODED_SEED_NODE("seed.varcoin.net:19898");
    } else {
    ...
    if (result != 0) {
      if (result == 1) {
        ...
        if (UPNP_AddPortMapping(urls.controlURL, igdData.first.servicetype, portString.str().c_str(), portString.str().c_str(), lanAddress, VarNote_NAME, "TCP", 0, "0") != 0) {
