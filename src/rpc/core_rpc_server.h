...
namespace VarNote
{
  ...
  public:
    ...
    core_rpc_server(core& cr, nodetool::node_server<VarNote::t_VarNote_protocol_handler<VarNote::core> >& p2p);
  ...
  private:
    ...
    core& m_core;
    nodetool::node_server<VarNote::t_VarNote_protocol_handler<VarNote::core> >& m_p2p;
    std::string m_port;
