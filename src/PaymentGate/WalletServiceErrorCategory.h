...
inline std::error_code make_error_code(VarNote::error::WalletServiceErrorCode e) {
  return std::error_code(static_cast<int>(e), VarNote::error::WalletServiceErrorCategory::INSTANCE);
}

namespace std {

template <>
struct is_error_code_enum<VarNote::error::WalletServiceErrorCode>: public true_type {};
