...
#include "VarNoteCore/OnceInInterval.h"
...
namespace VarNote
{
  ...
  struct P2pConnectionContext : public VarNoteConnectionContext {
  public:
    ...
    P2pConnectionContext(P2pConnectionContext&& ctx) : 
      VarNoteConnectionContext(std::move(ctx)),
      context(ctx.context),
      peerId(ctx.peerId),
  ...
  public:
    ...
    NodeServer(System::Dispatcher& dispatcher, VarNote::VarNoteProtocolHandler& payload_handler, Logging::ILogger& log);
    ...
    VarNote::VarNoteProtocolHandler& get_payload_object();
    ...
    VarNote::PeerlistManager& getPeerlistManager() { return m_peerlist; }
  ...
  private:
    ...
    bool handshake(VarNote::LevinProtocol& proto, P2pConnectionContext& context, bool just_take_peerlist = false);
    bool timedSync();
    ...
    virtual bool invoke_notify_to_peer(int command, const BinaryArray& req_buff, const VarNoteConnectionContext& context) override;
    ...
    bool idle_worker();
    bool handle_remote_peerlist(const std::list<PeerlistEntry>& peerlist, time_t local_time, const VarNoteConnectionContext& context);
    ...
    VarNoteProtocolHandler& m_payload_handler;
