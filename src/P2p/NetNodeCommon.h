...
namespace VarNote {
  ...
  struct p2p_endpoint_stub: public IP2pEndpoint {
    ...
    virtual bool invoke_notify_to_peer(int command, const BinaryArray& req_buff, const VarNote::VarNoteConnectionContext& context) { return true; }
    virtual void for_each_connection(std::function<void(VarNote::VarNoteConnectionContext&, PeerIdType)> f) {}
