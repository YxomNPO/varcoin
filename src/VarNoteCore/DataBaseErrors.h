...
inline std::error_code make_error_code(VarNote::error::DataBaseErrorCodes e) {
  return std::error_code(static_cast<int>(e), VarNote::error::DataBaseErrorCategory::INSTANCE);
}
