...
#include "VarNoteCore/ITxPoolObserver.h"
...
namespace VarNote {
  ...
  public:
    OnceInTimeInterval(unsigned interval, VarNote::ITimeProvider& timeProvider)
  ...
  private:
    ...
    unsigned m_interval;
    VarNote::ITimeProvider& m_timeProvider;
  };
  ...
  public:
    tx_memory_pool(
      ...
      VarNote::ITransactionValidator& validator,
      VarNote::ITimeProvider& timeProvider,
      Logging::ILogger& log);
  ...
  private:
    ...
    VarNote::ITransactionValidator& m_validator;
    VarNote::ITimeProvider& m_timeProvider;
