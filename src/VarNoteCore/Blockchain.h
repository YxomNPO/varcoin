...
#include "VarNoteCore/BlockIndex.h"
#include "VarNoteCore/Checkpoints.h"
#include "VarNoteCore/Currency.h"
#include "VarNoteCore/IBlockchainStorageObserver.h"
...
namespace VarNote {
  ...
  using VarNote::BlockInfo;
  class Blockchain : public VarNote::ITransactionValidator {
  public:
    ...
    bool handleGetObjects(NOTIFY_REQUEST_GET_OBJECTS_request& arg, NOTIFY_RESPONSE_GET_OBJECTS_request& rsp); //Deprecated. Should be removed with VarNoteProtocolHandler.
  ...
  private:
    ...
    Blocks m_blocks;
    VarNote::BlockIndex m_blockIndex;
