...
inline std::error_code make_error_code(VarNote::error::TransactionValidationError e) {
  return std::error_code(static_cast<int>(e), VarNote::error::TransactionValidationErrorCategory::INSTANCE);
}
...
template <>
struct is_error_code_enum<VarNote::error::TransactionValidationError>: public true_type {};
