...
inline std::error_code make_error_code(VarNote::error::CoreErrorCode e) {
  return std::error_code(static_cast<int>(e), VarNote::error::CoreErrorCategory::INSTANCE);
}
...
template <>
struct is_error_code_enum<VarNote::error::CoreErrorCode>: public true_type {};
