...
inline std::error_code make_error_code(VarNote::error::BlockValidationError e) {
  return std::error_code(static_cast<int>(e), VarNote::error::BlockValidationErrorCategory::INSTANCE);
}
...
template <>
struct is_error_code_enum<VarNote::error::BlockValidationError>: public true_type {};
