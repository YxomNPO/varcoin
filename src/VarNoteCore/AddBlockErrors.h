...
inline std::error_code make_error_code(VarNote::error::AddBlockErrorCode e) {
  return std::error_code(static_cast<int>(e), VarNote::error::AddBlockErrorCategory::INSTANCE);
}
...
template <>
struct is_error_code_enum<VarNote::error::AddBlockErrorCode>: public true_type {};
