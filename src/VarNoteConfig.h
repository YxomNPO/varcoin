...
namespace VarNote {
    namespace parameters {
        ...
        const uint64_t VARNOTE_MAX_BLOCK_NUMBER = 500000000;
        ...
        const size_t VARNOTE_MINED_MONEY_UNLOCK_WINDOW = 10;
...
// MONEY_SUPPLY - total number coins to be generated
        ...
        const size_t VARNOTE_BLOCK_GRANTED_FULL_REWARD_ZONE = 10000; //size of block (bytes) after which reward for block calculated using block size
        ...
        const uint64_t VARNOTE_LOCKED_TX_ALLOWED_DELTA_SECONDS =
                DIFFICULTY_TARGET * VARNOTE_LOCKED_TX_ALLOWED_DELTA_BLOCKS;
        ...
        const size_t FUSION_TX_MAX_SIZE = VARNOTE_BLOCK_GRANTED_FULL_REWARD_ZONE * 30 / 100;
        const size_t FUSION_TX_MIN_INPUT_COUNT = 12;
        const size_t FUSION_TX_MIN_IN_OUT_COUNT_RATIO = 4;

        const uint64_t UPGRADE_HEIGHT = 15177;
        ...
        const char VARNOTE_BLOCKS_FILENAME[] = "blocks.dat";
        const char VARNOTE_BLOCKINDEXES_FILENAME[] = "blockindexes.dat";
        const char VARNOTE_BLOCKSCACHE_FILENAME[] = "blockscache.dat";
        const char VARNOTE_POOLDATA_FILENAME[] = "poolstate.bin";
        const char P2P_NET_DATA_FILENAME[] = "p2pstate.bin";
        const char VARNOTE_BLOCKCHAIN_INDICES_FILENAME[] = "blockchainindices.dat";
    ...
    const CheckpointData CHECKPOINTS[] = {
            {1,    "d1ceea4ceb9236be0549ac0af1b3af980cd729c867044d9ce76c0f479b6a0b95"},
            {10,   "617b146d869dea010a650fba6fbc086b9284a92302bae1a295244c8fa1458e73"},
            {100,  "cafcc2e364f799a93520fe85bf418fe5fdf0004ea7999f38874725513efb8fd6"},
