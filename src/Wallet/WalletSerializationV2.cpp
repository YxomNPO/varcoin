...
struct WalletTransactionDtoV2 {
  ...
  WalletTransactionDtoV2(const VarNote::WalletTransaction& wallet) {
    state = wallet.state;
...
struct WalletTransferDtoV2 {
  ...
  WalletTransferDtoV2(const VarNote::WalletTransfer& tr) {
    address = tr.address;
    amount = tr.amount;
...
void serialize(UnlockTransactionJobDtoV2& value, VarNote::ISerializer& serializer) {
...
void serialize(WalletTransactionDtoV2& value, VarNote::ISerializer& serializer) {
  ...
  VarNote::serializeBlockHeight(serializer, value.blockHeight, "blockHeight");
...
void serialize(WalletTransferDtoV2& value, VarNote::ISerializer& serializer) {
...
void WalletSerializerV2::loadKeyListAndBanalces(VarNote::ISerializer& serializer, bool saveCache) {
  size_t walletCount;
...
void WalletSerializerV2::saveKeyListAndBanalces(VarNote::ISerializer& serializer, bool saveCache) {
...
void WalletSerializerV2::loadTransactions(VarNote::ISerializer& serializer) {
  uint64_t count = 0;
...
void WalletSerializerV2::saveTransactions(VarNote::ISerializer& serializer) {
...
void WalletSerializerV2::loadTransfers(VarNote::ISerializer& serializer) {
  uint64_t count = 0;
...
void WalletSerializerV2::saveTransfers(VarNote::ISerializer& serializer) {
...
void WalletSerializerV2::loadTransfersSynchronizer(VarNote::ISerializer& serializer) {
...
void WalletSerializerV2::saveTransfersSynchronizer(VarNote::ISerializer& serializer) {
...
void WalletSerializerV2::loadUnlockTransactionsJobs(VarNote::ISerializer& serializer) {
...
void WalletSerializerV2::saveUnlockTransactionsJobs(VarNote::ISerializer& serializer) {
  auto& index = m_unlockTransactions.get<TransactionHashIndex>();
