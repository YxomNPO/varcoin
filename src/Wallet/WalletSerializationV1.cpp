...
struct WalletTransferDto {
  ...
  WalletTransferDto(const VarNote::WalletTransfer& tr, uint32_t version) : WalletTransferDto(version) {
    address = tr.address;
    amount = tr.amount;
...
void serialize(ObsoleteSpentOutputDto& value, VarNote::ISerializer& serializer) {
...
void serialize(ObsoleteChangeDto& value, VarNote::ISerializer& serializer) {
...
std::string decrypt(const std::string& cipher, VarNote::WalletSerializerV1::CryptoContext& cryptoContext) {
  std::string plain;
...
template<typename Object>
void deserializeEncrypted(Object& obj, const std::string& name, VarNote::WalletSerializerV1::CryptoContext& cryptoContext, Common::IInputStream& source) {
...
void WalletSerializerV1::loadWalletV1Keys(VarNote::BinaryInputStreamSerializer& serializer) {
...
void WalletSerializerV1::loadWalletV1Details(VarNote::BinaryInputStreamSerializer& serializer) {
