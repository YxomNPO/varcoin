...
inline std::error_code make_error_code(VarNote::error::WalletErrorCodes e) {
  return std::error_code(static_cast<int>(e), VarNote::error::WalletErrorCategory::INSTANCE);
}

namespace std {

template <>
struct is_error_code_enum<VarNote::error::WalletErrorCodes>: public true_type {};
