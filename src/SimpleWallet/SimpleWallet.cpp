...
const command_line::arg_descriptor<uint16_t> arg_daemon_port = { "daemon-port", "Use daemon instance at port <arg> instead of 19998", 0 };
...
simple_wallet::simple_wallet(System::Dispatcher& dispatcher, const VarNote::Currency& currency, Logging::LoggerManager& log) :
  ...
  m_consoleHandler.setHandler("start_mining", boost::bind(&simple_wallet::start_mining, this, _1), "start_mining [<number_of_threads>] - Start mining in daemon =(sm)");
  m_consoleHandler.setHandler("stop_mining", boost::bind(&simple_wallet::stop_mining, this, _1), "Stop mining in daemon =(spm)");
  m_consoleHandler.setHandler("balance", boost::bind(&simple_wallet::show_balance, this, _1), "Show current wallet balance =(bc)");
  m_consoleHandler.setHandler("incoming_transfers", boost::bind(&simple_wallet::show_incoming_transfers, this, _1), "Show incoming transfers =(it)");
  m_consoleHandler.setHandler("list_transfers", boost::bind(&simple_wallet::listTransfers, this, _1), "Show all known transfers =(lt)");
  m_consoleHandler.setHandler("payments", boost::bind(&simple_wallet::show_payments, this, _1), "payments <payment_id_1> [<payment_id_2> ... <payment_id_N>] - Show payments <payment_id_1>, ... <payment_id_N> =(pm)");
  m_consoleHandler.setHandler("bc_height", boost::bind(&simple_wallet::show_blockchain_height, this, _1), "Show blockchain height =(bh)");
  m_consoleHandler.setHandler("transfer", boost::bind(&simple_wallet::transfer, this, _1),
    "transfer <mixin_count> <addr_1> <amount_1> [<addr_2> <amount_2> ... <addr_N> <amount_N>] [-p payment_id] [-f fee] =(t)"
    " - Transfer <amount_1>,... <amount_N> to <address_1>,... <address_N>, respectively. "
    "<mixin_count> is the number of transactions yours is indistinguishable from (from 0 to maximum available)");
  m_consoleHandler.setHandler("set_log", boost::bind(&simple_wallet::set_log, this, _1), "set_log <level> - Change current log level, <level> is a number 0-4 =(sl)");
  m_consoleHandler.setHandler("address", boost::bind(&simple_wallet::print_address, this, _1), "Show current wallet public address =(a)");
  m_consoleHandler.setHandler("save", boost::bind(&simple_wallet::save, this, _1), "Save wallet synchronized data =(s)");
  m_consoleHandler.setHandler("reset", boost::bind(&simple_wallet::reset, this, _1), "Discard cache data and start synchronizing from the start =(rs)");
  m_consoleHandler.setHandler("help", boost::bind(&simple_wallet::help, this, _1), "Show this help =(h)");
  m_consoleHandler.setHandler("exit", boost::bind(&simple_wallet::exit, this, _1), "Close wallet =(e)");
  m_consoleHandler.setHandler("sm", boost::bind(&simple_wallet::start_mining, this, _1), "");
  m_consoleHandler.setHandler("spm", boost::bind(&simple_wallet::stop_mining, this, _1), "");
  m_consoleHandler.setHandler("bc", boost::bind(&simple_wallet::show_balance, this, _1), "");
  m_consoleHandler.setHandler("it", boost::bind(&simple_wallet::show_incoming_transfers, this, _1), "");
  m_consoleHandler.setHandler("lt", boost::bind(&simple_wallet::listTransfers, this, _1), "");
  m_consoleHandler.setHandler("pm", boost::bind(&simple_wallet::show_payments, this, _1), "");
  m_consoleHandler.setHandler("bh", boost::bind(&simple_wallet::show_blockchain_height, this, _1), "");
  m_consoleHandler.setHandler("t", boost::bind(&simple_wallet::transfer, this, _1),"");
  m_consoleHandler.setHandler("sl", boost::bind(&simple_wallet::set_log, this, _1), "");
  m_consoleHandler.setHandler("a", boost::bind(&simple_wallet::print_address, this, _1), "");
  m_consoleHandler.setHandler("s", boost::bind(&simple_wallet::save, this, _1), "");
  m_consoleHandler.setHandler("rs", boost::bind(&simple_wallet::reset, this, _1), "");
  m_consoleHandler.setHandler("h", boost::bind(&simple_wallet::help, this, _1), "");
  m_consoleHandler.setHandler("e", boost::bind(&simple_wallet::exit, this, _1), "");
