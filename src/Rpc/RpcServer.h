...
class Core;
class NodeServer;
struct IVarNoteProtocolHandler;

class RpcServer : public HttpServer {
public:
  RpcServer(System::Dispatcher& dispatcher, Logging::ILogger& log, Core& c, NodeServer& p2p, IVarNoteProtocolHandler& protocol);
...
private:
  ...
  Core& m_core;
  NodeServer& m_p2p;
  IVarNoteProtocolHandler& m_protocol;
};
