...
std::error_code walletSaveWrapper(VarNote::IWalletLegacy& wallet, std::ofstream& file, bool saveDetailes, bool saveCache) {
  VarNote::WalletHelper::SaveWalletResultObserver o;
...
void WalletHelper::SendCompleteResultObserver::sendTransactionCompleted(VarNote::TransactionId transactionId, std::error_code result) {
  std::lock_guard<std::mutex> lock(m_mutex);
  m_finishedTransactions[transactionId] = result;
  m_condition.notify_one();
}

std::error_code WalletHelper::SendCompleteResultObserver::wait(VarNote::TransactionId transactionId) {
...
WalletHelper::IWalletRemoveObserverGuard::IWalletRemoveObserverGuard(VarNote::IWalletLegacy& wallet, VarNote::IWalletLegacyObserver& observer) :
  m_wallet(wallet),
  m_observer(observer),
  m_removed(false) {
...
void WalletHelper::storeWallet(VarNote::IWalletLegacy& wallet, const std::string& walletFilename) {
