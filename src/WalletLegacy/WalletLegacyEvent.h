...
public:
  ...
  virtual void notify(Tools::ObserverManager<VarNote::IWalletLegacyObserver>& observer) = 0;
};
...
public:
  ...
  virtual void notify(Tools::ObserverManager<VarNote::IWalletLegacyObserver>& observer) override
  {
