...
public:
  ...
  bool serialize(VarNote::ISerializer& serializer);
  ...
  void updateTransaction(TransactionId transactionId, const VarNote::Transaction& tx, uint64_t amount, const std::list<TransactionOutputInformation>& usedOutputs);
