...
public:
  WalletLegacy(const VarNote::Currency& currency, INode& node);
...
private:
  ...
  Tools::ObserverManager<VarNote::IWalletLegacyObserver> m_observerManager;
