...
VARIANT_TAG(binary_archive, VarNote::tx_extra_padding, TX_EXTRA_TAG_PADDING);
VARIANT_TAG(binary_archive, VarNote::tx_extra_pub_key, TX_EXTRA_TAG_PUBKEY);
VARIANT_TAG(binary_archive, VarNote::tx_extra_nonce, TX_EXTRA_NONCE);
VARIANT_TAG(binary_archive, VarNote::tx_extra_merge_mining_tag, TX_EXTRA_MERGE_MINING_TAG);
