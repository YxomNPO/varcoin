...
#include "VarNote_protocol/VarNote_protocol_handler_common.h"
...
namespace VarNote
{
  ...
  /************************************************************************/
   ...
   {
   public:
     core(i_VarNote_protocol* pprotocol);
     bool handle_get_objects(NOTIFY_REQUEST_GET_OBJECTS::request& arg, NOTIFY_RESPONSE_GET_OBJECTS::request& rsp, VarNote_connection_context& context);
     bool on_idle();
     ...
     i_VarNote_protocol* get_protocol(){return m_pprotocol;}
