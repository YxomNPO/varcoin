...
namespace boost
{
  ...
  {
    template<class archive_t>
    void serialize(archive_t & ar, VarNote::tx_memory_pool::tx_details& td, const unsigned int version)
    {
      ar & td.blob_size;
      ar & td.fee;
      ar & td.tx;
...
BOOST_CLASS_VERSION(VarNote::tx_memory_pool, CURRENT_MEMPOOL_ARCHIVE_VER)
