...
public:
  ...
  virtual void notify(tools::ObserverManager<VarNote::IWalletObserver>& observer) = 0;
};
...
public:
  ...
  virtual void notify(tools::ObserverManager<VarNote::IWalletObserver>& observer)
  {
