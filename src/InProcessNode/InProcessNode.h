...
class InProcessNode : public INode, public VarNote::IVarNoteProtocolObserver, public VarNote::ICoreObserver {
public:
  InProcessNode(VarNote::ICore& core, VarNote::IVarNoteProtocolQuery& protocol);
  ...
  virtual void getNewBlocks(std::vector<Crypto::Hash>&& knownBlockIds, std::vector<VarNote::block_complete_entry>& newBlocks, uint32_t& startHeight, const Callback& callback) override;
...
private:
  ...
  void getNewBlocksAsync(std::vector<Crypto::Hash>& knownBlockIds, std::vector<VarNote::block_complete_entry>& newBlocks, uint32_t& startHeight, const Callback& callback);
  std::error_code doGetNewBlocks(std::vector<Crypto::Hash>&& knownBlockIds, std::vector<VarNote::block_complete_entry>& newBlocks, uint32_t& startHeight);
  ...
  void relayTransactionAsync(const VarNote::Transaction& transaction, const Callback& callback);
  ...
  State state;
  VarNote::ICore& core;
  VarNote::IVarNoteProtocolQuery& protocol;
