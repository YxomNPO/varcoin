...
bool LegacyBlockChainReader::import_blockchain2(const std::string &coin_folder, BlockChainState *block_chain) {
	//	std::fstream ts_file("/Users/user/varcoin/timestamps.txt",
...
void LegacyBlockChainWriter::write_block(const varcoin::RawBlock &raw_block) {
	varcoin::BinaryArray ba = seria::to_binary(raw_block);
