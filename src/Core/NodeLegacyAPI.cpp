...
bool Node::on_getblocktemplate(http::Client *who, http::RequestData &&raw_request, json_rpc::Request &&raw_js_request,
    api::varcoind::GetBlockTemplate::Request &&req, api::varcoind::GetBlockTemplate::Response &res) {
	api::varcoind::GetStatus::Request sta;
...
void Node::getblocktemplate(const api::varcoind::GetBlockTemplate::Request &req,
    api::varcoind::GetBlockTemplate::Response &res) {
...
bool Node::on_get_currency_id(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::varcoind::GetCurrencyId::Request && /*req*/, api::varcoind::GetCurrencyId::Response &res) {
	res.currency_id_blob = m_block_chain.get_genesis_bid();
	return true;
}

bool Node::on_submitblock(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::varcoind::SubmitBlock::Request &&req, api::varcoind::SubmitBlock::Response &res) {
...
bool Node::on_submitblock_legacy(http::Client *who, http::RequestData &&rd, json_rpc::Request &&jr,
    api::varcoind::SubmitBlockLegacy::Request &&req, api::varcoind::SubmitBlockLegacy::Response &res) {
	if (req.size() != 1) {
		throw json_rpc::Error{CORE_RPC_ERROR_CODE_WRONG_PARAM, "Wrong param"};
	}

	api::varcoind::SubmitBlock::Request other_req;
...
bool Node::on_get_last_block_header(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::varcoind::GetLastBlockHeaderLegacy::Request &&,
    api::varcoind::GetLastBlockHeaderLegacy::Response &response) {
...
bool Node::on_get_block_header_by_hash(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::varcoind::GetBlockHeaderByHashLegacy::Request &&request,
    api::varcoind::GetBlockHeaderByHashLegacy::Response &response) {
...
bool Node::on_get_block_header_by_height(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::varcoind::GetBlockHeaderByHeightLegacy::Request &&request,
    api::varcoind::GetBlockHeaderByHeightLegacy::Response &response) {
	Hash block_hash;
