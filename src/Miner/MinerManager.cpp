...
#include "VarNoteCore/CachedBlock.h"
...
MinerManager::MinerManager(System::Dispatcher& dispatcher, const VarNote::MiningConfig& config, Logging::ILogger& logger) :
...
void MinerManager::startMining(const VarNote::BlockMiningParameters& params) {
...
void MinerManager::adjustBlockTemplate(VarNote::BlockTemplate& blockTemplate) const {
