...
bool gen_double_spend_base<concrete_test>::check_block_verification_context(
    std::error_code bve, size_t event_idx, const VarNote::BlockTemplate& /*block*/) {
...
bool gen_double_spend_base<concrete_test>::check_block_verification_context(std::error_code bve, size_t event_idx,
                                                                            const VarNote::RawBlock& /*block*/) {
  return (m_invalid_block_index == event_idx) ? blockWasNotAdded(bve) : blockWasAdded(bve);
}

template <class concrete_test>
bool gen_double_spend_base<concrete_test>::mark_last_valid_block(VarNote::Core& c, size_t /*ev_index*/,
                                                                 const std::vector<test_event_entry>& /*events*/) {
  std::vector<VarNote::BlockTemplate> blocks;
  ...
  for (size_t i = 0; i < rawBlocks.size(); ++i) {
    ...
    std::cout << VarNote::CachedBlock(blocks[i]).getBlockHash() << std::endl;
  }
...
template <class concrete_test>
bool gen_double_spend_base<concrete_test>::mark_invalid_tx(VarNote::Core& /*c*/, size_t ev_index,
                                                           const std::vector<test_event_entry>& /*events*/) {
...
template <class concrete_test>
bool gen_double_spend_base<concrete_test>::mark_invalid_block(VarNote::Core& /*c*/, size_t ev_index,
                                                              const std::vector<test_event_entry>& /*events*/) {
...
template <class concrete_test>
bool gen_double_spend_base<concrete_test>::check_double_spend(VarNote::Core& c, size_t /*ev_index*/,
                                                              const std::vector<test_event_entry>& events) {
  using std::cout;
  using std::endl;
  using VarNote::CachedBlock;
  ...
  //cout << VarNote::CachedBlock(m_last_valid_block).getBlockHash() << endl;
  //cout << endl;
  //for (auto _ : blocks) cout << VarNote::CachedBlock(_).getBlockHash() << endl;
  ...
  VarNote::AccountBase bob_account = boost::get<VarNote::AccountBase>(events[2]);
  VarNote::AccountBase alice_account = boost::get<VarNote::AccountBase>(events[3]);

  std::vector<VarNote::BlockTemplate> chain;
  map_hash2tx_t mtx;
