...
const uint64_t UNDEF_HEIGHT = static_cast<uint64_t>(VarNote::UpgradeDetectorBase::UNDEF_HEIGHT);
...
public:
  CheckBlockPurged(size_t invalidBlockIdx, uint8_t blockMajorVersion) :
    ...
    currencyBuilder.upgradeHeight(blockMajorVersion == VarNote::BLOCK_MAJOR_VERSION_1 ? UNDEF_HEIGHT : UINT64_C(0));
