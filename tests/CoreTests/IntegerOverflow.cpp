...
void append_TransactionSourceEntry(std::vector<VarNote::TransactionSourceEntry>& sources, const Transaction& tx,
                                   size_t out_idx) {
...
bool gen_uint_overflow_base::check_block_verification_context(std::error_code bve, size_t event_idx,
  ...
  return check_block_verification_context(bve, event_idx, VarNote::BlockTemplate{});
}

bool gen_uint_overflow_base::mark_last_valid_block(VarNote::Core& c, size_t ev_index,
