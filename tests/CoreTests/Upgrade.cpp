...
namespace {
  bool makeBlocks(std::vector<test_event_entry>& events, test_generator& generator, Block& lastBlock,
                  const Block& parentBlock, const VarNote::AccountBase& minerAcc, size_t count,
                  uint8_t majorVersion, uint8_t minorVersion) {
    VarNote::Block prevBlock = parentBlock;
...
bool gen_upgrade::checkBeforeUpgrade(std::vector<test_event_entry>& events, test_generator& generator,
                                     const VarNote::Block& parentBlock, const VarNote::AccountBase& minerAcc,
...
bool gen_upgrade::check_block_verification_context(const VarNote::block_verification_context& bvc, size_t eventIdx, const VarNote::Block& /*blk*/) {
