...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_mempool_2(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_mempool_1(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.getTopBlockHash() == getBlockHash(boost::get<VarNote::BlockTemplate>(events[8])));
  CHECK_TEST_CONDITION(c.getAlternativeBlockCount() == 2);
  return true;
}
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched2(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_switched(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.getTopBlockHash() == getBlockHash(boost::get<VarNote::BlockTemplate>(events[14])));
  CHECK_TEST_CONDITION(c.getAlternativeBlockCount() == 3);
  return true;
}
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched_back(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.getTopBlockHash() == getBlockHash(boost::get<VarNote::BlockTemplate>(events[19])));
  CHECK_TEST_CONDITION(c.getAlternativeBlockCount() == 8);

  return true;
}
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_switched_back_1(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.getTopBlockHash() == getBlockHash(boost::get<VarNote::BlockTemplate>(events[26])));
  CHECK_TEST_CONDITION(c.getAlternativeBlockCount() == 8);

  return true;
}//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_switched_back_2(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.getTopBlockHash() == getBlockHash(boost::get<VarNote::BlockTemplate>(events[28])));
  CHECK_TEST_CONDITION(c.getAlternativeBlockCount() == 8);
  return true;
}
//-----------------------------------------------------------------------------------------------------
/*
bool gen_simple_chain_split_1::check_orphaned_chain_1(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_switched_to_alternative(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_2(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_switched_to_main(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_38(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_39(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_40(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_41(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
