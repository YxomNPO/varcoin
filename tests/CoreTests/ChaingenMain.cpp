...
#define GENERATE_AND_PLAY_EX_2VER(TestCase)                                                                            \
  ...
  GENERATE_AND_PLAY_EX(TestCase(VarNote::BLOCK_MAJOR_VERSION_2))
      ...
      // GENERATE_AND_PLAY(gen_ring_signature_big); // Takes up to XXX hours (if VARNOTE_MINED_MONEY_UNLOCK_WINDOW ==
      // 10)

      //// BlockTemplate verification tests
      GENERATE_AND_PLAY_EX_2VER(TestBlockMajorVersionAccepted);
      GENERATE_AND_PLAY_EX(
          TestBlockMajorVersionRejected(VarNote::BLOCK_MAJOR_VERSION_1, VarNote::BLOCK_MAJOR_VERSION_2));
      GENERATE_AND_PLAY_EX(
          TestBlockMajorVersionRejected(VarNote::BLOCK_MAJOR_VERSION_2, VarNote::BLOCK_MAJOR_VERSION_1));
      GENERATE_AND_PLAY_EX(
          TestBlockMajorVersionRejected(VarNote::BLOCK_MAJOR_VERSION_2, VarNote::BLOCK_MAJOR_VERSION_2 + 1));
      ...
      // VARNOTE_MINED_MONEY_UNLOCK_WINDOW == 10
