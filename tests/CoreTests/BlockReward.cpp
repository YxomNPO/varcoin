...
bool gen_block_reward::mark_invalid_block(VarNote::Core& /*c*/, size_t ev_index,
                                          const std::vector<test_event_entry>& /*events*/) {
  m_invalid_block_index = ev_index + 1;
  return true;
}

bool gen_block_reward::mark_checked_block(VarNote::Core& /*c*/, size_t ev_index,
                                          const std::vector<test_event_entry>& /*events*/) {
...
bool gen_block_reward::check_block_rewards(VarNote::Core& /*c*/, size_t /*ev_index*/,
                                           const std::vector<test_event_entry>& events) {
