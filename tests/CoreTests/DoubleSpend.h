...
public:
  ...
  bool mark_invalid_tx(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool mark_invalid_block(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool check_double_spend(VarNote::Core& c, size_t ev_index, const std::vector<test_event_entry>& events);

private:
  VarNote::BlockTemplate m_last_valid_block;
...
public:
  ...
  bool check_tx_verification_context(bool tve, bool tx_added, size_t event_idx, const VarNote::Transaction& tx);
  bool check_block_verification_context(std::error_code bve, size_t event_idx, const VarNote::BlockTemplate& block);
  bool check_block_verification_context(std::error_code, size_t, const VarNote::RawBlock&);
