...
bool gen_double_spend_in_different_chains::check_double_spend(VarNote::Core& c, size_t /*ev_index*/,
...
bool DoubleSpendBase::check_block_verification_context(std::error_code bve, size_t event_idx,
                                                       const VarNote::BlockTemplate& /*block*/) {
...
bool DoubleSpendBase::mark_last_valid_block(VarNote::Core& c, size_t /*ev_index*/,
                                            const std::vector<test_event_entry>& /*events*/) {
  m_last_valid_block = c.getTopBlockHash();
  return true;
}

bool DoubleSpendBase::mark_invalid_tx(VarNote::Core& /*c*/, size_t ev_index,
                                      const std::vector<test_event_entry>& /*events*/) {
  m_invalid_tx_index = ev_index + 1;
  return true;
}

bool DoubleSpendBase::mark_invalid_block(VarNote::Core& /*c*/, size_t ev_index,
                                         const std::vector<test_event_entry>& /*events*/) {
  m_invalid_block_index = ev_index + 1;
  return true;
}

bool DoubleSpendBase::check_double_spend(VarNote::Core& c, size_t /*ev_index*/,
                                         const std::vector<test_event_entry>& events) {
