...
TEST(get_account_address_as_str, works_correctly)
{
  ...
  std::string addr_str = VarNote::get_account_address_as_str(addr);
...
{
  VarNote::account_public_address addr;
  ASSERT_TRUE(VarNote::get_account_address_from_str(addr, test_keys_addr_str));
...
TEST(get_account_address_from_str, fails_on_invalid_address_format)
{
  ...
  ASSERT_FALSE(VarNote::get_account_address_from_str(addr, addr_str));
}
...
{
  std::string addr_str = base58::encode_addr(VarNote_PUBLIC_ADDRESS_BASE58_PREFIX, test_serialized_keys.substr(1));
...
TEST(get_account_address_from_str, fails_on_invalid_address_spend_key)
{
  ...
  std::string addr_str = base58::encode_addr(VarNote_PUBLIC_ADDRESS_BASE58_PREFIX, serialized_keys_copy);
...
{
  VarNote::account_public_address addr;
  ASSERT_TRUE(VarNote::get_account_address_from_str(addr, "002391bbbb24dea6fd95232e97594a27769d0153d053d2102b789c498f57a2b00b69cd6f2f5c529c1660f2f4a2b50178d6640c20ce71fe26373041af97c5b10236fc"));
}
