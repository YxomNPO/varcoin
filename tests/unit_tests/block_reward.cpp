...
namespace
{
  ...
  {
  protected:
    static const size_t current_block_size = VarNote_BLOCK_GRANTED_FULL_REWARD_ZONE / 2;
  ...
  protected:
    virtual void SetUp()
    {
      ...
      ASSERT_TRUE(m_block_not_too_big);
      ASSERT_LT(VarNote_BLOCK_GRANTED_FULL_REWARD_ZONE, m_standard_block_reward);
    }
  ...
  {
    do_test(0, VarNote_BLOCK_GRANTED_FULL_REWARD_ZONE - 1);
    ASSERT_TRUE(m_block_not_too_big);
  ...
  {
    do_test(0, VarNote_BLOCK_GRANTED_FULL_REWARD_ZONE);
    ASSERT_TRUE(m_block_not_too_big);
    ASSERT_EQ(m_block_reward, m_standard_block_reward);
  }
  ...
  {
    do_test(0, 2 * VarNote_BLOCK_GRANTED_FULL_REWARD_ZONE - 1);
    ASSERT_TRUE(m_block_not_too_big);
    ASSERT_LT(m_block_reward, m_standard_block_reward);
  ...
  {
    do_test(0, 2 * VarNote_BLOCK_GRANTED_FULL_REWARD_ZONE);
    ASSERT_TRUE(m_block_not_too_big);
  ...
  protected:
    virtual void SetUp()
    {
      m_last_block_sizes.push_back(3  * VarNote_BLOCK_GRANTED_FULL_REWARD_ZONE);
      m_last_block_sizes.push_back(5  * VarNote_BLOCK_GRANTED_FULL_REWARD_ZONE);
      m_last_block_sizes.push_back(7  * VarNote_BLOCK_GRANTED_FULL_REWARD_ZONE);
      m_last_block_sizes.push_back(11 * VarNote_BLOCK_GRANTED_FULL_REWARD_ZONE);
      m_last_block_sizes.push_back(13 * VarNote_BLOCK_GRANTED_FULL_REWARD_ZONE);

      m_last_block_sizes_median = 7 * VarNote_BLOCK_GRANTED_FULL_REWARD_ZONE;
