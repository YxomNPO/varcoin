...
namespace {
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterANodeIsConnectedToAnotherIfTheirBlockchainsAreSynchronized) {
    ...
    std::unique_ptr<VarNote::INode> node0;
    std::unique_ptr<VarNote::INode> node1;
    std::unique_ptr<VarNote::INode> node2;
    std::unique_ptr<VarNote::INode> node3;
    ...
    std::vector<std::unique_ptr<VarNote::ITransactionReader>> poolTxs1;
    std::vector<std::unique_ptr<VarNote::ITransactionReader>> poolTxs2;
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterTimedBlockchainsSynchronization) {
    ...
    std::unique_ptr<VarNote::INode> node2;
    std::unique_ptr<VarNote::INode> node3;
    std::unique_ptr<VarNote::INode> node4;
    ...
    std::vector<std::unique_ptr<VarNote::ITransactionReader>> poolTxs2;
    std::vector<std::unique_ptr<VarNote::ITransactionReader>> poolTxs3;
    std::vector<std::unique_ptr<VarNote::ITransactionReader>> poolTxs4;
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterSwitchingToAlternativeChain) {
    ...
    VarNote::BlockTemplate blockTemplate2;
