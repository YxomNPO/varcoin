...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::check_tx_verification_context(const VarNote::tx_verification_context& tvc, bool tx_added, size_t event_idx, const VarNote::transaction& /*tx*/)
{
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::check_block_verification_context(const VarNote::block_verification_context& bvc, size_t event_idx, const VarNote::block& /*block*/)
{
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::mark_last_valid_block(VarNote::core& c, size_t /*ev_index*/, const std::vector<test_event_entry>& /*events*/)
{
  std::list<VarNote::block> block_list;
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::mark_invalid_tx(VarNote::core& /*c*/, size_t ev_index, const std::vector<test_event_entry>& /*events*/)
{
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::mark_invalid_block(VarNote::core& /*c*/, size_t ev_index, const std::vector<test_event_entry>& /*events*/)
{
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::check_double_spend(VarNote::core& c, size_t /*ev_index*/, const std::vector<test_event_entry>& events)
{
  ...
  std::list<VarNote::block> block_list;
  bool r = c.get_blocks(0, 100 + 2 * VarNote_MINED_MONEY_UNLOCK_WINDOW, block_list);
  ...
  VarNote::account_base bob_account = boost::get<VarNote::account_base>(events[1]);
  VarNote::account_base alice_account = boost::get<VarNote::account_base>(events[2]);

  std::vector<VarNote::block> chain;
  map_hash2tx_t mtx;
  std::vector<VarNote::block> blocks(block_list.begin(), block_list.end());
...
bool gen_double_spend_in_tx<txs_keeped_by_block>::generate(std::vector<test_event_entry>& events) const
{
  ...
  VarNote::tx_source_entry se;
  se.amount = tx_0.vout[0].amount;
  se.outputs.push_back(std::make_pair(0, boost::get<VarNote::txout_to_key>(tx_0.vout[0].target).key));
  se.real_output = 0;
...
bool gen_double_spend_in_the_same_block<txs_keeped_by_block>::generate(std::vector<test_event_entry>& events) const
{
  ...
  VarNote::transaction tx_1 = txs_1.front();
