...
public:
  ...
  bool check_block_purged(VarNote::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
  {
...
struct gen_block_accepted_base : public test_chain_unit_base
{
  ...
  bool check_block_accepted(VarNote::core& c, size_t /*ev_index*/, const std::vector<test_event_entry>& /*events*/)
  {
...
struct gen_block_miner_tx_has_2_in : public gen_block_verification_base<VarNote_MINED_MONEY_UNLOCK_WINDOW + 1>
{
  bool generate(std::vector<test_event_entry>& events) const;
};

struct gen_block_miner_tx_with_txin_to_key : public gen_block_verification_base<VarNote_MINED_MONEY_UNLOCK_WINDOW + 2>
{
  bool generate(std::vector<test_event_entry>& events) const;
};
