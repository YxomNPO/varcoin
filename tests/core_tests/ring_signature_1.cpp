...
bool gen_ring_signature_1::check_balances_1(VarNote::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
  ...
  bool r = c.get_blocks(0, 100 + 2 * VarNote_MINED_MONEY_UNLOCK_WINDOW, blocks);
...
bool gen_ring_signature_1::check_balances_2(VarNote::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
...
bool gen_ring_signature_2::check_balances_1(VarNote::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
...
bool gen_ring_signature_2::check_balances_2(VarNote::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
...
bool gen_ring_signature_big::generate(std::vector<test_event_entry>& events) const
{
  ...
  blocks.reserve(m_test_size + VarNote_MINED_MONEY_UNLOCK_WINDOW);
  ...
  for (size_t i = 0; i < m_test_size; ++i)
  {
    block blk_with_unlocked_out = blocks[blocks.size() - 1 - VarNote_MINED_MONEY_UNLOCK_WINDOW];
...
bool gen_ring_signature_big::check_balances_1(VarNote::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
  ...
  std::list<block> blocks;
  bool r = c.get_blocks(0, 2 * m_test_size + VarNote_MINED_MONEY_UNLOCK_WINDOW, blocks);
  CHECK_TEST_CONDITION(r);
...
bool gen_ring_signature_big::check_balances_2(VarNote::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
