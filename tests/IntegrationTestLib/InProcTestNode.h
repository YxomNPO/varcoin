...
public:
  InProcTestNode(const TestNodeConfiguration& cfg, const VarNote::Currency& currency);
  ~InProcTestNode();
  ...
  virtual bool getBlockTemplate(const std::string &minerAddress, VarNote::Block &blockTemplate, uint64_t &difficulty) override;
