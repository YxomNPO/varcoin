...
#include "VarNote_core/blockchain_storage.h"
...
bool make_tx(blockchain_storage& bch)
{
  ...
  if(found_money != needed_money)
  {
    ...
    VarNote::tx_destination_entry& destination = dsts.back();
  ...
  transaction tx;
  bool r = VarNote::construct_tx(m_account.get_keys(), sources, dsts, tx, unlock_time);
  if(!r)
  {
