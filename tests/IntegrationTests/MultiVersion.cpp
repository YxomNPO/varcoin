...
public:
  ...
  MultiVersionTest(const VarNote::Currency& currency, System::Dispatcher& d, const Tests::Common::BaseFunctionalTestsConfig& config, Logging::ILogger& log) :
  ...
  void run() {
    ...
    VarNote::AccountBase stashAddress;
